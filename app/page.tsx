...
export default function Home() {
  return (
    <div className="min-h-screen min-w-screen flex flex-row">
      <div className="min-h-screen w-full flex flex-row items-center justify-center align-middle  bg-gradient-to-r from-violet-600 to-violet-700 laptop:hidden desktop:block table:hidden phone:hidden">
